...
This is similar to the Singleton pattern, but a bit cleaner and more organized. The GameInitializer is safer than lazy instantiated singletons, because you can create and set up the services contextually. For example, if you have a test environment, you can create a custom initializer that injects test data into the services or creates fake services.
